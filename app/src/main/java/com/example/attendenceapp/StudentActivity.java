...
public class StudentActivity extends AppCompatActivity {
    ...
    private void loadData() {
        Cursor cursor = dbHelper.getStudentTable(did);
        Log.i("1234567890", "loadData: " + did);
        studentItems.clear();
    ...
    private void saveStatus() {
        for(StudentItem studentItem : studentItems){
            ...
            long value = dbHelper.addStatus(studentItem.getSid(),did,calendar.getDate(),status);
    ...
    private void addStudent(String roll_string, String name) {
        ...
        long sid = dbHelper.addStudent(did,roll,name);
